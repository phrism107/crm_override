<template>
  ...
  <div v-if="doc.name" class="flex h-full overflow-hidden">
    ...
    <!-- PHRISM: right pane shows the linked Organisation -->
...
function openEmailBox() {
  // PHRISM: the activity/email pane is not shown on the project detail page.
  if (!activities.value) {
    toast.error(__('Email is not available on the project view'))
    return
  }
